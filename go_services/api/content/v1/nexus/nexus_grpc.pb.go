...
const (
	...
	PostService_UpdatePostRenderedContent_FullMethodName = "/bifrost.content.v1.nexus.PostService/UpdatePostRenderedContent"
...
type PostServiceClient interface {
	...
	// [内部/系统接口] 回写渲染后的 HTML (供 Rust Forge 调用)
	UpdatePostRenderedContent(ctx context.Context, in *UpdatePostRenderedContentRequest, opts ...grpc.CallOption) (*UpdatePostRenderedContentResponse, error)
	// 删除文章
...
func (c *postServiceClient) UpdatePostRenderedContent(ctx context.Context, in *UpdatePostRenderedContentRequest, opts ...grpc.CallOption) (*UpdatePostRenderedContentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdatePostRenderedContentResponse)
	err := c.cc.Invoke(ctx, PostService_UpdatePostRenderedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServiceServer interface {
	...
	// [内部/系统接口] 回写渲染后的 HTML (供 Rust Forge 调用)
	UpdatePostRenderedContent(context.Context, *UpdatePostRenderedContentRequest) (*UpdatePostRenderedContentResponse, error)
	// 删除文章
...
func (UnimplementedPostServiceServer) UpdatePostRenderedContent(context.Context, *UpdatePostRenderedContentRequest) (*UpdatePostRenderedContentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePostRenderedContent not implemented")
}
...
func _PostService_UpdatePostRenderedContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePostRenderedContentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServiceServer).UpdatePostRenderedContent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostService_UpdatePostRenderedContent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).UpdatePostRenderedContent(ctx, req.(*UpdatePostRenderedContentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdatePostRenderedContent",
			Handler:    _PostService_UpdatePostRenderedContent_Handler,
		},
		{
